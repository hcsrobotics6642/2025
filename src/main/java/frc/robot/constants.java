...
public class constants {
    ...
    public static final String LIMELIGHT__RIGHT_NAME = "limelight-right";
    ...
    public static final Distance CORAL_APRILTAG_HEIGHT = Distance.ofBaseUnits(58.5, Inches);
      ...
      public static class ArmConstants  {
        ...
        public static final double kLowerLimit = -30000;
        public static final double kTolearance = 2;
        public static final double kManualSpeed = 0.3;
        public static final double L1pos = -1.7;
        public static final double L2pos = -45;
        public static final double L3pos = -86.7;
        public static final double L4pos = -146.7;
        public static final double Lstowpos = 40;
        public static final double CPivotStow = .83;
        public static final double CPivotScore = .300;
        ...
        public static final double APivotGrab = .1;
        public static final double APivotStow = 8;
